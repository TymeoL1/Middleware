...
/**
 * This enumerated type models the role of a participation by a
 * user, meaning a member, and possibly also a moderator, of the
 * social network.
 * 
...
public enum ParticipationRole {
	 ...
	 */
	ParticipationRole(final String name) {
		this.name = name;
	}
