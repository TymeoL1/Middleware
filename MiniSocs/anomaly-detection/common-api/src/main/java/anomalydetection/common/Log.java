...
public final class Log {
	 ...
	 */
	public static final String LOGGER_NAME_ANOMALY_DETECTION = "anomaly-detection";
	/**
	 * logger object for the general part.
	 */
	public static final Logger ANOMALY = LogManager.getLogger(LOGGER_NAME_ANOMALY_DETECTION);
	/**
